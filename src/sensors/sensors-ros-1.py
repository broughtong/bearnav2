...
if __name__ == '__main__':
    ...
    repeat_fusion = PF2D(type_prefix="repeat", particles_num=1000, odom_error=0.05, odom_init_std=1.0, align_beta=40.0,
                         align_init_std=0.3, particles_frac=1, choice_beta=1.0, debug=True,
